...
{
    //ESP_LOGF("FUNC", "sc_ack_send_get_errno");
...
{
    //ESP_LOGF("FUNC", "sc_ack_send_task");
...
{
    //ESP_LOGF("FUNC", "sc_ack_send_stop");
...
{
    //ESP_LOGF("FUNC", "sc_ack_send_info");
