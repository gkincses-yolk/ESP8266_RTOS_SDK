...
{
    ESP_LOGV("FUNC", "ff_raw_initialize ");
...
{
    ESP_LOGV("FUNC", "ff_diskio_register_raw_partition");
...
{
    ESP_LOGV("FUNC", "ff_diskio_get_pdrv_raw");
