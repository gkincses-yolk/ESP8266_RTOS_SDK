...
{
    ESP_LOGV("FUNC", "find_context_index_by_path");
...
{
    ESP_LOGV("FUNC", "find_unused_context_index");
...
{
    ESP_LOGV("FUNC", "esp_vfs_fat_register");
...
{
    ESP_LOGV("FUNC", "esp_vfs_fat_unregister_path");
...
{
    ESP_LOGV("FUNC", "fresult_to_errno");
...
static int vfs_fat_closedir(void* ctx, DIR* pdir)
{
    ESP_LOGV("FUNC", "vfs_fat_closedir");
...
{
    ESP_LOGV("FUNC", "vfs_fat_readdir_r");
...
static int vfs_fat_truncate(void* ctx, const char *path, off_t length)
{
    ESP_LOGV("FUNC", "vfs_fat_truncate");
